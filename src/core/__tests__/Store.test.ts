...
describe('core/Store', () => {
  ...
  // ЮНИТ-ТЕСТ на тестирование события
  test('should emit event after store was update', () => {
    // 1 Arrange
  ...
  // ЮНИТ-ТЕСТ на тестирование вызова функции
  test('should call callback with store and dispatch when it is function', () => {
    const store = new Store({ userId: -1 });
    const mock = jest.fn();
